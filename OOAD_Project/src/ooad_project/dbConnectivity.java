...
public class dbConnectivity 
{
    ...
    public ArrayList<String> getProjectBeneficiaries(String p)
    {
        ArrayList<String> names = new ArrayList<>();
        try{
           ResultSet rs = stmt.executeQuery("select beneficiary from beneficiaryprojects where project like '"+p+"'");
           while(rs.next())
           {
               names.add(rs.getString(1));
           }
    ...
    public ArrayList<String> getProjectDonors(String p)
    {
        ArrayList<String> names = new ArrayList<>();
        try{
           ResultSet rs = stmt.executeQuery("select donor from donation where project like '"+p+"'");
           while(rs.next())
           {
               names.add(rs.getString(1));
           }
